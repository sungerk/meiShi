...
public class Slider extends CustomView {
    ...
    private OnNumberIndicatorConvert onNumberIndicatorConvert;
    ...
    public void setOnNumberIndicatorConvert(OnNumberIndicatorConvert onNumberIndicatorConvert) {
        this.onNumberIndicatorConvert = onNumberIndicatorConvert;
    }
    ...
    private String getNumberIndicatorValue(long val) {
        if (onNumberIndicatorConvert == null)
            return val + "";
        else {
            return onNumberIndicatorConvert.covert(val);
        }
    }

    public interface OnNumberIndicatorConvert {
        String covert(long val);
    }
